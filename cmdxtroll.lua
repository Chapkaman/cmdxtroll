...
function Stand(Text1,Text2,Text3,Text4,Text5,Text6,Btn)
	...
	Help.Text = "Besoin d'aide ? Va te faire enculer fdp "..cordCode
...
Stand("JE T'AI ENCULER TON PC ENCULER VA AHAHHAH", "PLEURE PLEURE", "Je rigole ct un prank Wassim de mort là", "", "", "CONTINUE MAINTENANT OU JE T'ENCULE", true)
while not RunDude do wait() end
...
cmd.PlaceholderText = "Ecris une commande ici sale noir"
cmd.Text = ""
